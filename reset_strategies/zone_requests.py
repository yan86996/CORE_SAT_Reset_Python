...
class Requests:
    ...
    for each zone
    """
    def __init__(self, verbose=False, ignore=[], important=[], folder_dir = None, zone_names=None, zone_dev_map = None, room_temp=None,    
                 clg_setpoint=None, htg_setpoint=None, flow=None, flow_min=None, flow_max=None, damper=None, lim_dt_errs = 20, fdd=False, low_temp_cutoff=None, high_temp_cutoff=None):
